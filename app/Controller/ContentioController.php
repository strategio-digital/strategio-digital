...
class ContentioController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        $this->template->pointList = $this->getPointList();
        $this->template->technologies = $this->getTechnologies();
        $this->template->modules = $this->getModules();
    }
    
    public static function getCorePointList(): array
    {
        return [
    ...
    protected function getPointList(): array
    {
        return [
            'core' => self::getCorePointList(),
            'more' => [
